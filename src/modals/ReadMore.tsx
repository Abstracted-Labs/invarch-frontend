...
const ReadMore = (props: ReadMoreProps) => {
  ...
  return isOpen ? (
    <Dialog open={true} onClose={closeModal}>
      ...
      <Dialog.Panel>
        <>
          <div className={`fixed left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-1/2 z-50 flex flex-col justify-between w-[350px] h-[472px] rounded-xl space-y-4 p-8 border border-[2px] border-invarchOffBlack ${ BG_GRADIENT }`}>
            <div className="flex items-center space-x-4">
              ...
              <div className="flex flex-col items-start gap-1 justify-start">
                ...
                <span className="text-xs text-invarchOffBlack">Project Description</span>
              </div>
            </div>
            <div className="overflow-y-auto h-3/5 tinker-scrollbar scrollbar scrollbar-thumb-invarchPink pr-5">
              <p className="text-invarchOffBlack text-[14px] tracking-[0] leading-[18px]">
                {description}
              </p>
            </div>
            <div>
